...
public class FileStorage extends AbstractStorage<File> {
    ...
    protected FileStorage(File directory, StreamSerializer streamSerializer) {
        ...
        if (!directory.isDirectory()) throw new IllegalArgumentException(directory.getAbsolutePath() + " i not directory");
    ...
    protected void doUpdate(Resume r, File file) {
        try {
            ...
            throw new StorageException("File write error error", r.getUuid(), e);
        }
    }
    ...
    public int size() {
        ...
        if (list == null) throw new StorageException("Directory read error");
        return list.length;
    }
}
